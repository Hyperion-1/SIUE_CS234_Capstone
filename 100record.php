        ...
        $card = "
            <div class='w3-card-4' style='width: 40%'>
              ...
              <div class='w3-container'>
                <p>Class Number: CS $classNumber</p>
                <p>Class Name: $className</p>
              </div>
              <a href='100Classes.php' class='w3-button w3-block w3-dark-grey'>Ok</a>
              <a href='100Classes.php' class='w3-button w3-block w3-dark-grey>ADD</a>
            </div>
        ";
